  ...
  return {
    ...
    update: function update(req, res) {
      ...
      var _req$body = req.body,
        _id = _req$body._id,
        price = _req$body.price; // Extract item ID and price from request body
      ...
      cart.totalPrice = Object.values(cart.items).reduce(function (total, item) {
...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('/admin/order', {
    headers: {
      "X-Requested-With": 'XMLHttpRequest'
    }
  }).then(function (res) {
...
/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! noty */ "./node_modules/noty/lib/noty.js");
/* harmony import */ var noty__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(noty__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _app_http_controllers_customers_cartController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../app/http/controllers/customers/cartController */ "./app/http/controllers/customers/cartController.js");
/* harmony import */ var _app_http_controllers_customers_cartController__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_app_http_controllers_customers_cartController__WEBPACK_IMPORTED_MODULE_2__);
...
function updateCart(cake) {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/update-cart', cake).then(function (res) {
...
if (adminAreaPath.includes('admin')) initAdmin(socket);
socket.emit('join', 'adminRoom');

//listening the client

socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //copying the order
